...
func TestReElection2A(t *testing.T) {
	...
	fmt.Printf("disconnect two servers %d %d\n", leader2, (leader2+1)%servers)
	time.Sleep(2 * RaftElectionTimeout)
...
func TestFailAgree2B(t *testing.T) {
	...
	log.Printf("s%d disconnected", (leader+1)%servers)
	...
	log.Printf("s%d reconnected", (leader+1)%servers)
...
func TestFailNoAgree2B(t *testing.T) {
	...
	log.Printf("disconnect 3 servers; one leader and follower is left\n")
	...
	log.Printf("reconnect 3 servers\n")
...
func TestRejoin2B(t *testing.T) {
	...
	leader1 := cfg.checkOneLeader()
	cfg.disconnect(leader1)
	log.Printf("s%d(leader) disconnect ", leader1)
	...
	leader2 := cfg.checkOneLeader()
	cfg.disconnect(leader2)
	log.Printf("s%d(leader) disconnect ", leader2)

	// old leader connected again
	cfg.connect(leader1)
	log.Printf("s%d reconnect ", leader1)

	cfg.one(104, 2, true)

	// all together now
	cfg.connect(leader2)
	log.Printf("%d reconnect ", leader2)
